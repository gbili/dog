...
class TranslateWriter extends \Zend\I18n\View\Helper\AbstractTranslatorHelper
{
    ...
    public function getFilename($lcModuleName, $locale)
    {
        ...
        $localeCountry = array('en' => 'en_US', 'es' => 'es_ES', 'fr' => 'fr_FR', 'de' => 'de_DE');

        if (!isset($localeCountry[$locale])) {
            throw new \Exception('Add a key with :' . $locale . ' and the ISO locale_COUNTRY match as value');
        }
