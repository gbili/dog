...
class TranslatePostController extends \User\Controller\LoggedInController 
{
    /**
     * List all posts with their langs
     * add a checkbox to allow linking
     * posts together (all chosen posts
     * must be of different lang)
     */
    public function indexAction()
    {
        ...
        $offset = ((null !== $paramPage)? $paramPage * $limit : 0);
    ...
    public function bulkAction()
    {
        if (!$this->request->isPost()) {
            $this->redirect->toRoute(null, array('controller' => 'index'), true);
        }

        $form = new \Lang\Form\PostLinkTranslations($this->getServiceLocator());
