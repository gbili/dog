...
namespace DoctrineORMModule\Proxy\__CG__\GbiliUserModule\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class UserData extends \GbiliUserModule\Entity\UserData implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GbiliUserModule\\Entity\\UserData' . "\0" . 'id', '' . "\0" . 'GbiliUserModule\\Entity\\UserData' . "\0" . 'user', '' . "\0" . 'GbiliUserModule\\Entity\\UserData' . "\0" . 'posts', '' . "\0" . 'GbiliUserModule\\Entity\\UserData' . "\0" . 'categories', '' . "\0" . 'GbiliUserModule\\Entity\\UserData' . "\0" . 'medias', '' . "\0" . 'GbiliUserModule\\Entity\\UserData' . "\0" . 'dogs', '' . "\0" . 'GbiliUserModule\\Entity\\UserData' . "\0" . 'profile');
        }
     ...
     * {@inheritDoc}
     */
    public function setProfile(\GbiliUserModule\Entity\ProfileInterface $profile)
    {
