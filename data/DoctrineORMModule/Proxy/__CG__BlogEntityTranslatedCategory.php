 ...
 */
class TranslatedCategory extends \Blog\Entity\TranslatedCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'translations');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TranslatedCategory $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addTranslation(\Blog\Entity\PostData $translation)
    {
    ...
    public function addTranslations(\Doctrine\Common\Collections\Collection $translations)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addTranslations', array($translations));
    ...
    public function removeTranslations(\Doctrine\Common\Collections\Collection $translations)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeTranslations', array($translations));

        return parent::removeTranslations($translations);
    }
